...
-- Add coordinates to partner_listings
...
-- Add coordinates to trip_templates too for consistency
ALTER TABLE public.trip_templates
ADD COLUMN latitude numeric NULL,
ADD COLUMN longitude numeric NULL;

-- Update the trigger that creates trips from approved listings to copy coordinates
