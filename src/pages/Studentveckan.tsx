...
const Studentveckan = () => {
  ...
  useEffect(() => {
    const jsonLd = {
      ...
      "description": "En unik seglingsresa i Kroatien tillsammans med studenter från hela Sverige. Flyg, segelbåt, event och 24/7 service ingår.",
      ...
      "offers": {
        "@type": "Offer",
        "priceCurrency": "SEK",
        "url": "https://www.studentresor.com/studentveckan"
      },
      "provider": {
        "@type": "TravelAgency",
        "name": "Studentresor",
